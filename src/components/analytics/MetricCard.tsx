...
export function MetricCard({ title, value, icon, loading, trend }: MetricCardProps) {
  return (
    <div className="bg-[#141414] print:bg-white p-6 rounded-2xl shadow-sm border border-[#222222] print:border-gray-300 flex flex-col gap-3 transition-all duration-300 hover:shadow-[0_0_20px_rgba(57,255,20,0.15)] hover:border-[#39FF14] print:shadow-none print:break-inside-avoid group">
